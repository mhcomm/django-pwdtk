"""
Django settings for pwdtk.testproject.dj22 project.
...
ROOT_URLCONF = 'pwdtk.testproject.dj22.urls'
...
WSGI_APPLICATION = 'pwdtk.testproject.dj22.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(
            TOP_DIR,
            os.environ.get('PWDTK_DB_FILE', 'db22.sqlite3')),
    }
}
