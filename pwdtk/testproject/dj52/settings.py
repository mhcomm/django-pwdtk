"""
Django settings for pwdtk.testproject.dj52 project.
...
ROOT_URLCONF = 'pwdtk.testproject.dj52.urls'
...
WSGI_APPLICATION = 'pwdtk.testproject.dj52.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(
            TOP_DIR,
            os.environ.get('PWDTK_DB_FILE', 'db52.sqlite3')),
    }
}
...
if not any("MD5PasswordHasher" in val for val in PASSWORD_HASHERS):
