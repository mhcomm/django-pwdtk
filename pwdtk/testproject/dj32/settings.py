"""
Django settings for pwdtk.testproject.dj32 project.
...
ROOT_URLCONF = 'pwdtk.testproject.dj32.urls'
...
WSGI_APPLICATION = 'pwdtk.testproject.dj32.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(
            TOP_DIR,
            os.environ.get('PWDTK_DB_FILE', 'db32.sqlite3')),
    }
}
