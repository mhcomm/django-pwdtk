"""
Django settings for pwdtk.testproject.dj1 project.
...
MANUALLY MODIFIED TO USE OLD MIDDLEWARE_CLASSES
"""
...
SECRET_KEY = '_dpccdgh41c4^u_ms*a^e@0q4p_m!%)o^9#n@(hxd608bxr2=w'
...
WSGI_APPLICATION = 'pwdtk.testproject.dj1.wsgi.application'
